...
/**
 * Fetches default animation library items filtered by organization and application
 ...
 */
const getDefaultAnimationLibrary = async (
  orgId?: string,
  appId?: string,
  partyId?: string,
  options?: {
  ...
  try {
    ...
    console.error(`getDefaultAnimationLibrary error: ${error.message}`);
    return { animationLibrary: [] };
  }
};

export default getDefaultAnimationLibrary;
